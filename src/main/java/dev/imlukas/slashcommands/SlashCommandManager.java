...
public class SlashCommandManager {
    ...
    public void init(Guild guild, CommandType type) {
        ...
        for (SlashCommand command : getSlashCommands()) {
            ...
            if (clazz.isAnnotationPresent(dev.imlukas.slashcommands.annotations.SlashCommand.class)) {
                commandType = clazz.getAnnotation(dev.imlukas.slashcommands.annotations.SlashCommand.class).type();
            }
