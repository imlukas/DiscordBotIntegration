...
public class EmbedBuilders {
    ...
    public static EmbedBuilder getMusicEmbed() {
        return new EmbedBuilder().setColor(Colors.GREEN.getColor()).setFooter("Verux:tm:").clearFields();
    }

    public static EmbedBuilder createBuilder(Colors color, String... fields) {
        EmbedBuilder builder = new EmbedBuilder().setColor(color.getColor()).setFooter("Verux:tm:").clearFields();
    ...
    public static EmbedBuilder success(String title, Colors color) {
        return new EmbedBuilder().setTitle("[Success] " + title).setColor(color.getColor()).setFooter("Verux:tm:");
    }
    ...
    public static EmbedBuilder error(String title, Colors color) {
        return new EmbedBuilder().setTitle("[Error] " + title).setColor(color.getColor()).setFooter("Verux:tm:");
    }
}
